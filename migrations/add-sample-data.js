...
const insertAlbums = `
  ...
  ('Album 1', 'Author 1', '2020-01-01', 'Description for Album 1', 'images/master_cover.jpg'),
  ('Album 2', 'Author 2', '2019-01-01', 'Description for Album 2', null),
  ('Album 3', 'Author 3', '2018-01-01', 'Description for Album 3', null)
`;
